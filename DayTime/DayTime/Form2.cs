...
namespace DayTime
{
    public partial class Form2 : Form
    {
        ...
        public Form2(Socket socketFd,string username, IPEndPoint end)
        {
            ...
            Thread t = new Thread(OpenNewFrom);
            t.Start();
            //receive.Hide();
        ...
        {
            Form5 receive = new Form5(this, fd, endPoint);
            receive.Show();
        }
        ...
        private void ReceiveCallback2(IAsyncResult ar)
        {
            try
            {
                ...
                if (b!='\n')
                {
                    ...
                    b = a[a.Length - 1];
                    MessageBox.Show("jjj" + a +  a.Length.ToString() + b.ToString());
        ...
        private void ForumRefreshButton_Click(object sender, EventArgs e)
        {
           ...
           // fd.BeginReceive(state.m_DataBuf, 0, SocketStateObject2.BUF_SIZzE, 0, new AsyncCallback(ReceiveCallback2), state);
